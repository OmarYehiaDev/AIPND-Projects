        ...
        for ii, (inputs, labels) in enumerate(dataloaders[0]): # 0 = train
            ...
            if steps % print_stepper == 0:
                ...
                print("Epoch: {}/{}... ".format(e+1, epochs),
                      "Training Loss: {:.4f}".format(running_loss/print_stepper),
...
def main():
    print("Starting..") # Just to make sure that I can see anything before it takes forever to train :"
    args = parse_args()
    ...
    validataion_transforms = transforms.Compose([transforms.Resize(256), transforms.CenterCrop(224), transforms.ToTensor(),
                                                 transforms.Normalize([0.485, 0.456, 0.406], 
                                                                      [0.229, 0.224, 0.225])]) # I know the spacing looks awful but please skip it :"(
